...
import mehdi.bad.addons.utils.RoundedUtils;
...
public class ConfigGuiNew extends GuiScreen {
    ...
    private static void getSettings() {
        ...
        Iterator var2 = BadAddons.settings.iterator();
        ...
        if (searchBar != null && !searchBar.getText().equals("")) {
            ...
            Iterator var4 = BadAddons.settings.iterator();
    ...
    private void drawSearchBar(int var1, int var2, int var3, int var4, int var5) {
        ...
        //RoundedUtils.drawRoundedRect(var1, var2, var3, var4, 32, (new Color(255, 255, 255, 165)).getRGB());
        GuiUtils.drawTexture(new ResourceLocation("badaddons:search.png"), var1 + var6, var2 + var6, var5, var5);
        drawRect(var1 + var6 * 2 + var5, var2 + var6 + var5, var3 - var6, var2 + var6 + var5 + 1, (new Color(255, 255, 255, 255)).getRGB());
        //RoundedUtils.drawRoundedRect(var1 + var6 * 2 + var5, var2 + var6 + var5, var3 - var6, var2 + var6 + var5 + 1,);
    ...
    public void drawScreen(int var1, int var2, float var3) {
        ...
        byte var6 = 9;
        String var7 = "BadAddons 1.0";
        this.drawCenteredString(this.mc.fontRendererObj, var7, var4 + this.mc.fontRendererObj.getStringWidth(var7) / 2 + var6, var5 + 15 - 3, -1);
        GuiUtils.drawTexture(new ResourceLocation("badaddons:exit-17x17.png"), var4 + 500 - var6 - 12, var5 + var6, 12, 12);
    ...
    private void drawFirstLine() {
        ...
        while (var1.hasNext()) {
            ...
            //RoundedUtils.drawRoundedRect(var2.x, var2.y, var2.x + var2.width, var2.y + var2.height, 8, Color.BLACK.getRGB());
            this.drawString(this.mc.fontRendererObj, (var2 == selectedFirstCategory ? "§a" : "§c") + var2.name, var2.x + 3, var2.y + 3, -1);
        }
    ...
    public void onGuiClosed() {
        BadAddons.mc.gameSettings.guiScale = this.startScale;
        Config.save();
    }

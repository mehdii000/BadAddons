...
import mehdi.bad.addons.Events.DungeonRoomEnterEvent;
...
import mehdi.bad.addons.Features.Dungeons.utils.RoomDetectionUtils;
...
import static mehdi.bad.addons.Features.Dungeons.catacombs.DungeonManager.*;
        ...
        return stage2Executor.submit(() -> {
            ...
            for (Map.Entry<BlockPos, Integer> entry : blocksToCheck.entrySet()) {
                ...
                for (String direction : possibleDirections) {
                    ...
                    long idToCheck = DungeonUtils.shortToLong((short) relative.getX(), (short) relative.getY(),
